...
describe('User Management Emulator', () => {
  ...
  describe('getUserByEmail', () => {
    it('should get user by email successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts:lookup`,
        {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer mock-access-token',
  ...
  describe('createUser', () => {
    it('should create user successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts`,
        {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer mock-access-token',
  ...
  describe('updateUser', () => {
    it('should update user successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts:update`,
        {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer mock-access-token',
  ...
  describe('deleteUser', () => {
    it('should delete user successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts:delete`,
        {
          method: 'POST',
          headers: {
            'Authorization': 'Bearer mock-access-token',
  ...
  describe('listUsers', () => {
    it('should list users successfully', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts:query?maxResults=10`,
        {
          method: 'GET',
          headers: {
            'Authorization': 'Bearer mock-access-token',
    ...
    it('should list users with page token', async () => {
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        `http://${EMU_HOST}/identitytoolkit.googleapis.com/v1/projects/test-project/accounts:query?maxResults=50&nextPageToken=page-token-123`,
        {
          method: 'GET',
          headers: {
            'Authorization': 'Bearer mock-access-token',
